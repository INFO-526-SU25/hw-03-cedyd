...
Sources: https://plotly.com/r/horizontal-bar-charts/ https://plotly.com/r/text-and-annotations/
...
print(covid_survey_longer_grouped)
```
...
print(covid_survey_longer_grouped)
```
```{r plot_covid_survey_all, fig.width=10, fig.height=7}
...
```{r plot_covid_survey_all_stacked, fig.width=14, fig.height=10}
#| label: plot_covid_survey_all_stacked
ggplot(covid_survey_longer_grouped, aes(y = pct, fill = response_value, x = "")) +
  coord_flip() +
